...
<div class="divSessionDetails">
  ...
  <a href="SelectInterview.php?rsid=<?php echo $rSessionID ?>&rname=<?php echo $rName ?>&rjob=<?php echo $rJob ?>&rdate=<?php echo $rDate ?>&rstatus=<?php echo $rStatus ?>"><input type="button" id="interviewButton" value="Interview"></a>
</div>
    ...
    <?php					
        ...
        while($raw = $data->fetch_row()) {     
			if($raw[8] == "Rejected - CV"){
				...
				$color = "#FFCC33";
			}else if($raw[8] == "Rejected - 1st interview"){
				$color = "#FF0000";
