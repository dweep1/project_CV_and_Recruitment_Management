...
jQuery(function(){
    ...
    jQuery('a.add-member').click(function(event){
        ...
        var newRow = jQuery('<tr><td><input type="text" name="empid' +
            ...
            counter + '"/></td><td><input type="text" name="email' +
            counter + '"/></td><td><input type="text" name="contact' +
            counter + '"/></td></tr>');
...
jQuery(function(){
    ...
    jQuery('a.addmore').click(function(event){
        ...
        var newRow = jQuery('<tr><td><input type="text" name="date' +
            counter + '"/></td><td><input type="text" name="time' +
            counter + '"/></td></tr>');
...
<form method="post" action=<?php echo "CreateInterview.php?rsid=".$rSessionID.'&rname='.$rName.''?>>
  ...
  <br><br>
  <table class="panel-list" border="1" style="width:90%">
	  <thead>
		<tr>
			<th>EmpID</th>
			<th>Name</th>
