...
<div>
  ...
  <?php while($row = $criteria->fetch_row()){
	...
	?>
    <tr>
      <td width="100%"><input type="number" name="<?php echo $row[0];?>" value="<?php echo $marks[0];?>" class="textInputEnterCandidateDetails" placeholder="<?php echo $row[0];?>"></td>      
    </tr>
  <?php }?>
  <tr>
      <td width="100%"><input type="text" name="comments" value="" class="textInputEnterCandidateDetails" placeholder="comments"></td>      
    </tr>
