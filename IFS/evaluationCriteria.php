...
<div>
  ...
  <input type="text" class="createNewPanelTextBox" placeholder="Criteria Name">
  <br/>
  <br/>
...
<form action="test1.php" method="post" name="f"> 
  ...
  <thead>
    <tr>
      ...
      <th width="45%" scope="col">Weight %</th>
    </tr>
   </thead>
<tbody id="dataTable">
...
<input id="btnID" type="submit" value="Save" name="submit" href="evaluationCriteria.php"/>
