...
//    echo $raw1[0];
    ...
    <form role="form" action=<?php echo "form.php?id=".$id.""?> method="post">
        ...
        Status: <input type="text" name="d8" class="form-control" value=<?php echo $raw[8];?>><br>
        <a class="btn btn-default" style="color: white; background-color: darkorchid" href="home.php" >back</a>
...
<div class="col-md-6">
    <object data=<?php echo $raw1[0];?> type="application/pdf" width="600" height="650"
        ...
        alt : <a href=<?php echo $raw1[0];?>>test.pdf</a>
    </object>
</div>
